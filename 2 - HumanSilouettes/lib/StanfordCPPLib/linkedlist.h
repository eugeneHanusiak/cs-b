...
public:
     ...
     */
    LinkedList();
    /* implicit */ LinkedList(const std::queue<ValueType>& v);
     ...
     */
    std::queue<ValueType> toStlList() const;
...
private:
    ...
    /* Instance variables */
    std::queue<ValueType> m_elements;   // STL linked list as backing storage
...
public:
     ...
     */
    class iterator : public std::queue<ValueType>::iterator {
    public:
        iterator() : std::queue<ValueType>::iterator() {}
        iterator(const iterator& it) : std::queue<ValueType>::iterator(it) {}
        iterator(const typename std::queue<ValueType>::iterator& it) : std::queue<ValueType>::iterator(it) {}
    };
    class const_iterator : public std::queue<ValueType>::const_iterator {
    public:
        const_iterator() : std::queue<ValueType>::const_iterator() {}
        const_iterator(const const_iterator& it) : std::queue<ValueType>::const_iterator(it) {}
        const_iterator(const typename std::queue<ValueType>::const_iterator& it) : std::queue<ValueType>::const_iterator(it) {}
    };
...
template <typename ValueType>
LinkedList<ValueType>::LinkedList(const std::queue<ValueType>& v) {
    m_elements = v;
}
...
template <typename ValueType>
std::queue<ValueType> LinkedList<ValueType>::toStlList() const {
    return m_elements;
}
